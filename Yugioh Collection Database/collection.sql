...
INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
    ...
    VALUES (85138716, "Rescue Rabbit", "Earth", 4, "Beast", "Cannot be Special 
            ...
            same name from your Deck, but destroy them during the End Phase. You can only use this effect of 'Rescue Rabbit' once per turn.", "1st", "SR04-EN020", 300, 100, 1, 3);
...
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
    VALUES (84808313, "Big Evolution Pill", "Spell", "Normal", "After this card's activation, it remains on the field, but destroy it during your opponent's 3rd End Phase. Tirbute 1 Dinosaur-Type monster to activate this card; while this card is face-up on the field, you can Normal Summon Level 5 or higher Dinosaur-Type monsters without Tributing.", "1st", "SR04-EN023", 3);
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
    VALUES (43898403, "Twin Twisters", "Spell", "Quick-Play", "Discard 1 card, then target up to 2 Spell/Trap Cards on the field; destroy them.", "1st", "SR04-EN024", 3);
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
    VALUES (48976825, "Burial from a Different Dimension", "Spell", "Quick-Play", "Target up to 3 banished monsters; return them to the Graveyard.", "1st", "SR04-EN025", 3);
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
    VALUES (129223641, "Swords of Concealing Light", "Spell", "Continuous", "Destroy this card during your 2nd Standby Phase after activation. When this card resolves, change all monsters your opponent controls to face-down Defense Position. Monster your opponent controls cannot change their battle positions.", "1st", "SR04-EN026", 3);
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
    VALUES (01033312, "Painful Decision", "Spell", "Normal", "Send 1 Level 4 or 
            lower Normal Monster from your Deck to the Graveyard, and if you do, add 1 card with the same name as the card from your Deck to your hand. You can only activate 1 'Painful Decision' per turn.", "1st", 
            "SR04-EN027", 3);
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
...
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
    VALUES (73628505, "Terraforming", "Spell", "Normal", "Add 1 Field Spell Card from your Deck to your hand.", "1st", "SR04-EN029", 3);

/* Lastly we have the traps */
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
    VALUES (58272005, "Survival of the Fittest", "Trap", "Normal", "Target 1 Dinosaur-Type monster you control; equip this card to that target. 
            It gains 1000 ATK. When that attacking monster destroys an 
            opponenet's monster by battle and sends it to the graveyard: You can activate this effect; the equiped monster can make a second attack on an opponent's monster in a row.", "1st", "SR04-EN031", 3);
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
    VALUES (23869735, "Fossil Excavation", "Trap", "Continuous", "Activate this card by discarding 1 card, then target 1 Dinosaur-Type monster in your Graveyard; Special Summon that target. Negate the effects of that monster on the field. When this card leaves the field, destroy that monster. When that monster is destroyed, destroy this card.", "1st", "SR04-EN032", 3);
INSERT INTO Cards (id, name, attribute, type, description, edition, series,
                    quantity)
...
INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
    ...
    VALUES (82044279, "Clear Wing Synchro Dragon", "Wind", 8, "Dragon", "1 Tuner 
            ...
            monster's original ATK until the end of this turn.", "1st", "CROS-EN046", 2500, 2000, 1, 1, "Ghost", 1);
...
INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
    ...
    VALUES (80666118, "Scarlight Red Dragon Archfiend", "Dark", 8, "Dragon", "1 
            ...
            (other than this card), then inflict 500 damage to your opponent for each monster destroyed.", "1st", "DOCS-EN046", 3000, 2500, 1, 1,
            "Ghost", 1);
...
INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
    ...
    VALUES (44508094, "Stardust Dragon", "Wind", 8, "Dragon", "1 Tuner + 1 or 
            ...
            that destroys a card(s) on the field and destroy that card. If you 
            negate an effect this way, you can Special Summon this card from 
            your Graveyard during the End Phase.", "Unlimited", "TDGS-EN040", 2500, 2000, 1, 1, "Ultimate", 1);
...
INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
    ...
    VALUES (25958491, "Ancient Sacred Wyvern", "Light", 7, "Fairy", "1 Light 
            ...
            destroyed by battle and sent to the Graveyard, you can pay 1000 Life Points to Special Summon this card.", "1st", "TDGS-EN040", 2100, 2000, 1, 1, "Ultimate", 1);

INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
                    edition, series, atk, def, effect, synchro, rarity, 
                    quantity)
    VALUES (97836203, "T.G. Halberd Cannon", "Earth", 12, "Machine", "1 Tuner 
            Synchro Monster + 2 or more non-Tuner Synchro Monsters  This card 
            cannot be Special Summoned except by Synchro Summon. Once per turn, 
            while this card is face-up on the field, you can negate the Summon 
            of a monster and destroy it. When this card is sent from the field 
            to the Graveyard, you can select 1 'T.G.' monster in your Graveyard, 
            and Special Summon it.", "1st", "EXVC-EN043", 4000, 4000, 1, 1,
            "Ultimate", 1);
...
INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
    ...
    VALUES (06021033, "Doomkaiser Dragon", "Earth", 6, "Zombie",
            "Plaguespreader Zombie + 1 more non-Tuner Zombie-Type monsters  When 
            this card is Special Summoned, you can select 1 Zombie-Type monster 
            in your opponent's Graveyard and Special Summon it to your side of 
            the field in Attack Position. Destroy it when this card is removed 
            from the field.", "Unlimited", "CSOC-EN043", 2800, 2000, 1, 1,
            "Slightly Played", 1);

INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
                    edition, series, atk, def, effect, synchro, rarity, 
                    quantity)
    VALUES (51447164, "T.G. Blade Blaster", "Earth", 10, "Machine", "1 Tuner 
            Synchro Monster + 1 or more non-Tuner Synchro Monsters  When an 
            opponent's Spell/Trap Card is activated that targets this card, you 
            can send 1 card from your hand to the Graveyard to negate the 
            ...
            from play. During the next Standby Phase, Special Summon this card, 
            if removed by this effect.", "1st", "EXVC-EN042", 3300, 2200, 1, 1,
            "Ultimate", 1);

INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
                    edition, series, atk, def, effect, synchro, tuner, rarity, 
                    quantity)
    VALUES (50091196, "Formula Synchron", "Light", 2, "Machine", "1 Tuner  + 2 
            non-Tuner monster  When this card is Synchro Summoned: You can draw 
            1 card. During your opponent's Main Phase, you can: Immediately 
            after this effect resolves, Synchro Summon using this card you 
            control (this is a Quick Effect).", "1st", "LC5D-EN041", 200, 1500, 
            1, 1, 1, "Secret", 2);

INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
                    edition, series, atk, def, effect, synchro, rarity, 
                    quantity)
    VALUES (74586817, "PSY-Framelord Omega", "Light", 8, "Psychic", "1 Tuner 1 
            or more non-Tuner monsters  Once per turn, during either player's 
            Main Phase: You can banish this card from the field and 1 random 
            card from your opponent's hand, face-up, until your next Standby 
            Phase. Once per turn, during your opponent's Standby Phase: You can 
            target 1 banished card: return it to the Graveyard. If this card is 
            in your Graveyard: You can target 1 other card in either player's 
            Graveyard; shuffle both that card and this card from the Graveyard 
            into the Deck.", "1st", "HSRD-EN035", 2800, 2200, 1, 1, "Secret",
            1);

INSERT INTO Cards (id, name, attribute, level_rank_link, type, description,
                    edition, series, atk, def, effect, synchro, rarity, 
                    quantity)
    VALUES (08310162, "Malefic Paradox Dragon", "Dark", 10, "Dragon", "Malefic 
            Parallel Gear + 1 non-Tuner 'Malefic' monster  When this card is 
            Synchro Summoned, you can select 1 Synchro Monster in either 
            player's Graveyard, and Special Summon it. There can only be 1 face-
            up 'Malefic World' is not face-up on the field, destroy this card.",
            "Limited", "YMP1-EN007", 4000, 4000, 1, 1, "Secret", 2);
